...
def copy_results(scene_name, room_name):
    src_path = os.path.join("scenes", scene_name, room_name)
    dst_path = os.path.join("results", scene_name, room_name)

    if os.path.exists(src_path):
        shutil.copytree(src_path, dst_path)
        print(f"Copied results to '{dst_path}'")
    else:
...
def process_scene(scene_path):
    ...
    if scene_path_half:
        ...
        copy_results(scene_name, room_name_oct)
